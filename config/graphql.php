...
use App\GraphQL\Mutations\DeleteBookMutation;
use App\GraphQL\Mutations\UpdateBookMutation;
use App\GraphQL\Query\AuthorQuery;
use App\GraphQL\Query\AuthorsQuery;
...
return [
    ...
    'schemas' => [
        'default' => [
            ...
            'mutation' => [
                \App\GraphQL\Mutations\CreateBookMutation::class,
                UpdateBookMutation::class,
                DeleteBookMutation::class,
            ],
